...
// tools/crypto_vendor_entry.mjs
var crypto_vendor_entry_exports = {};
__export(crypto_vendor_entry_exports, {
  aesGcmDecrypt: () => aesGcmDecrypt,
  aesGcmEncrypt: () => aesGcmEncrypt,
  bytesToHex: () => bytesToHex,
  entropyBytesToMnemonic: () => entropyBytesToMnemonic,
  hexToBytes: () => hexToBytes,
  mnemonicToEntropyBytes: () => mnemonicToEntropyBytes,
  validateEnglishMnemonic: () => validateEnglishMnemonic
});
module.exports = __toCommonJS(crypto_vendor_entry_exports);
...
function validateEnglishMnemonic(mnemonic) {
...
function mnemonicToEntropyBytes(mnemonic) {
  ...
  return typeof entropy === "string" ? Array.from(hexToBytes(entropy)) : Array.from(entropy);
}
function entropyBytesToMnemonic(bytes) {
...
function aesGcmDecrypt(key, nonce, cipher, tag) {
